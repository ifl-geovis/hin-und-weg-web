/* ==========================================================================
   util.js — utility functions, formatting, color helpers
   ========================================================================== */
   ...
   function calculate_classcount(choices, positive) {
       ...
       if (!Number.isNaN(selected)) {
           return Math.max(1, Math.min(5, selected));
       }
   ...
   /* PERFORMANCE FIX: cache Intl.NumberFormat instances instead of
      re-creating them on every call. Keyed by "min-max" decimal string. */
   ...
   /* Unified value formatter with NA handling */
   ...
   /* Format with as few decimals as possible, up to max 2 (de-DE) */
