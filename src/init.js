/* ==========================================================================
   init.js — application initialization, dataset bootstrapping
   ========================================================================== */
   ...
   function init_selections() {
	   ...
	   let load_dataset_btn = document.getElementById("load_dataset_button");
	   load_dataset_btn.disabled = true;
   ...
   function init_view()
   {
	   ...
	   {
		   app.view.positions[viewcomponent.id] = { x: 200, y: 100 };
	   }
	   app.view.positions.legend_view = { x: 50, y: 30 };
   }
   ...
   function start() {
	   /* Auto-select dataset 'bund' / category 'all' and load */
	   ...
	   if (app.datasets && app.datasets[datasetId]) {
		   ...
		   load_dataset(); /* FIX: removed unused null argument */
	   } else {
